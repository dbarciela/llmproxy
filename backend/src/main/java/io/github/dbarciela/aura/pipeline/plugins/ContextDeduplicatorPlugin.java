...
public class ContextDeduplicatorPlugin implements BufferingPlugin {
    ...
    private int blockCounter = 1; // Used to generate unique block IDs
    ...
    @Override
    public String getUiTabName() { return "Deduplicator"; }

    @Override
    public boolean hasUiToggle() { return true; }

    @Override
    public int getDefaultOrder() { return 10; }
    ...
    public void processRequest(RequestContext context) {
        ...
        try {
            ...
            for (int msgIdx = 1; msgIdx < messages.size(); msgIdx++) {
                ...
                if (currentMsg.has("content") && !history.isEmpty() && !"system".equals(currentMsg.path("role").asText())) {
                    ...
                    // Not a user message or doesn't have content to deduplicate, just append to history
