...
public class ProxyPipeline {
    ...
    public ProxyPipeline(List<ProxyPlugin> plugins, io.github.dbarciela.aura.config.PluginSettingsManager pluginSettingsManager) {
    ...
    public boolean requiresResponseBuffering() {
        io.github.dbarciela.aura.pipeline.plugins.ManualEditorPlugin.ManualEditorSettings manualSettings = 
            pluginSettingsManager.getSettingsAs("manual-editor", io.github.dbarciela.aura.pipeline.plugins.ManualEditorPlugin.ManualEditorSettings.class);
