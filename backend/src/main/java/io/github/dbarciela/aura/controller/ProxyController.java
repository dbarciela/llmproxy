...
public class ProxyController {
    ...
    private final io.github.dbarciela.aura.config.ProxySettings settings;
    private final io.github.dbarciela.aura.pipeline.LiveChatBroadcaster liveChatBroadcaster;

    public ProxyController(ProxyPipeline pipeline, io.github.dbarciela.aura.config.ProxySettings settings, io.github.dbarciela.aura.pipeline.LiveChatBroadcaster liveChatBroadcaster, @Value("${target.server.url}") String targetServerUrl) {
