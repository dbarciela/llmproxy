...
public class SettingsController {
    ...
    public SettingsController(ProxySettings settings, PluginSettingsManager pluginSettingsManager, io.github.dbarciela.aura.pipeline.ProxyPipeline proxyPipeline) {
