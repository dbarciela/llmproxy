...
import com.example.llamaproxy.pipeline.AsyncPlugin;
...
public class LiveChatPlugin implements AsyncPlugin {
    ...
    @Override
    public String getId() { return "live-chat-plugin"; }

    @Override
    public String getName() { return "Live Chat Interface"; }

    @Override
    public String getDescription() { return "Broadcasts SSE events to the UI Live Chat."; }

    @Override
    public Object getDefaultSettings() { return new LiveChatSettings(); }

    @Override
    public String getUiTabName() { return "Live Chat"; }

    @Override
    public boolean hasUiToggle() { return true; }

    @Override
    public int getDefaultOrder() { return 100; }
